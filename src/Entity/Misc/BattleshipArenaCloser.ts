...
export default class ArenaCloser extends TankBody {
    ...
    public constructor(game: GameServer) {
        ...
        this.barrels.splice(0, this.barrels.length);
         ...
         for (const barrelDefinition of TankDefinitions[Tank.Battleship].barrels) {

            const def = Object.assign({}, barrelDefinition, {droneCount: 4294967295, reload: 1});
            def.bullet = Object.assign({}, def.bullet, {type: "drone" , sizeRatio: 1, speed: 2, damage: 7, health: 500,  scatterRate: 1, lifeLength: 1, absorbtionFactor: 1 });
        ...
        this.name.values.name = "Battleship Arena Closer";
