...
export default class ArenaCloser extends TankBody {
    ...
    public constructor(game: GameServer) {
        ...
        this.barrels.splice(0, this.barrels.length);
         ...
         for (const barrelDefinition of TankDefinitions[Tank.MachineGun].barrels) {

            const def = Object.assign({}, barrelDefinition, {reload: 0.4});
        ...
        this.name.values.name = "Machine Gun Closer";
