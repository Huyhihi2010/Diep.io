    ...
    public constructor(game: GameServer) {
        ...
        this.barrels.splice(0, this.barrels.length);
         ...
         for (const barrelDefinition of TankDefinitions[Tank.Overlord].barrels) {
            ...
            const def = Object.assign({}, barrelDefinition, {droneCount: 2, reload: 1});
            def.bullet = Object.assign({}, def.bullet, {type: "drone" , sizeRatio: 1, speed: 2, damage: 7, health: 500});
        ...
        this.name.values.name = "Overlord Arena Closer";
