...
export default class Teams4Arena extends ArenaEntity {
    ...
    /** Yellow Team entity */
    public yellowTeam: TeamEntity = new TeamEntity(this.game, Colors.TeamYellow);
    ...
    public constructor(game: GameServer) {
        ...
        new TeamBase(game, this.yellowTeam, arenaSize / 2 - baseSize / 2, arenaSize / 2 - baseSize / 2, baseSize, baseSize);
    ...
    public spawnPlayer(tank: TankBody, client: Client) {
        ...
        if (chance < 0.2) {
            ...
            tank.relations.values.team = this.yellowTeam;
            tank.style.values.color = this.yellowTeam.team.values.teamColor;
            tank.position.values.x = (arenaSize / 2) - x;
            tank.position.values.y = (arenaSize / 2) - y;}
